...
######################################################
#  Copyright 2021 - Author(s):   Paulo H. SOUZA      #
######################################################
######################################################
...
######################################################
ui <-navbarPage("FMT - Análise de dados", windowTitle = 'FMT Análises', collapsible = TRUE, theme = shinytheme("paper"),
                ...
                (
                  ...
                  (
                    ...
                    (tags$head(tags$script('
                                           ...
                                           if(typeMessage == 8){
                                           $("a:contains(Tipo de analise)").click();
                                           }
                                           if(typeMessage == 9){
                     ...
                     br(),
                     tags$div(align="center",
                              actionButton("action5", label="Modelos para análise", onclick ="window.open('https://docs.google.com/document/d/1to1ORIJu0VtCZZFE2uiE7eAFz8Y2zbINuf6AE9NHkHY', '_blank')",
                                           class="btn btn-success", icon=icon("exclamation"), width="65%")
                     ),
                     br(),
                ...
                navbarMenu("Banco de Dados", icon=icon("arrow-up"),
                           ...
                           (
                             ...
                             (
                               ...
                               ######################################################
                               (
                                 conditionalPanel(condition  = "input.conj == 'csv' || input.conj == 'xlsx' || input.conj == 'labest'",
                           ...
                           tabPanel
                           (
                             "Copiar e colar", icon=icon("arrow-up"),
                             sidebarLayout
                             (
                               sidebarPanel
                               ...
                               (
                                 ...
                                 # Input: Seleciona o arquivo ----
                                 textAreaInput("AREA_DADOS", "Cole aqui sua base de dados"),
                                 ...
                                 tags$div(align="center",  border="0",
                                          actionButton("action32", label = "< Voltar", class="btn btn-success", width="100"),
                                          actionButton("action33", label = "Avançar >", class="btn btn-success", width="100")
                                 )
                                 
                               ),
                               # mainPanel(verbatimTextOutput("tabela")
                               mainPanel(tableOutput("tabela_colada"))
                ...
                ######################################################
                #              painel de Tipo de análise             #
                ######################################################
                tabPanel
                (
                  "Tipo de analise", icon=icon("check-circle"),
                  sidebarLayout
                  (
                    sidebarPanel
                    (
                      tags$form(id="formulario2", action="dados2",
                                # Input: Seleciona o Delineamento ----
                                
                                selectInput("tipo_analise", label = "Selecione o grupo de análise principal: ",
                                            choices = c('Anova e teste de médias (paramétrica)' = "parametrica",
                                                        'Rank e teste de medianas (não paramétrica)' = "nparametrica",
                                                        'Análise de sobrevivência - Kaplan e Log-Rank' = "sobrev",
                                                        'Multivariada' = "multiv",
                                                        'Análise gráfica' = "grafica"),
                                            selected = "anova"),
                                ...
                                tags$div(align="center",
                                         ...
                                         conditionalPanel(condition = "input.tipo_analise == 'parametrica'",
                           
                                              actionButton("action30", label = "< Voltar", class="btn btn-success", width="100"),
                                              actionButton("action31", label = "Avançar >", class="btn btn-success", width="100")
                                         ),
                                         
                                         conditionalPanel(condition = "input.tipo_analise == 'nparametrica'",
                                                          
                                                          #actionButton("action34", label = "< Voltar", class="btn btn-success", width="100"),
                                                          #actionButton("action35", label = "Avançar >", class="btn btn-success", width="100")
                                         )
                  ...
                  (
                    ...
                    (
                      tags$form(id="formulario", action="dados",
                                ...
                                selectInput("metodologia", label = "Selecione a metodologia de análise",
                                            choices = c('1. Dados desbalanceados (Número diferente de repetições e/ou múltiplos testes de médias)' = "easyanova",
                                                        '2. Dados balanceados (Mesmo número repetições)' = "expDes"),
                                                        selected = "easyanova"),
                           
                                conditionalPanel(condition = "input.metodologia == 'easyanova'",
                                                 selectInput("deli_easyanova", label = "Selecione o Delineamento",
                                                             choices = c('DIC' = "dic_easyanova",
                                                                         'DBC' = "dbc_easyanova"),
                                                             selected = "dic_easyanova"),
                                                 radioButtons("list_easy", "Analisar como: ", choices = c("Selecionar variavel" = "Uma", "Analisar todas variaveis" = "Todas"))
                                ),

                                
                                conditionalPanel(condition = "input.metodologia == 'expDes'",
                             ...
                             (
                                            sidebarPanel
                                             ...
                                             (
                                               ...
                                               conditionalPanel(condition = "input.deli == 'dic' & input.metodologia == 'expDes'",
                                               ...
                                               conditionalPanel(condition = "input.deli_easyanova == 'dic_easyanova' & input.metodologia == 'easyanova",{
                                                                #Intervalo de Teste F
                                                                sliderInput("sigF_easy_dic", "Selecione o nível de significância",min = 1, value = 5, max = 20, post = "%")
                               ...
                               mainPanel(
                                 ...
                                 ######################################################
                                 conditionalPanel(condition = "input.deli == 'dic' || input.deli_easyanova == 'dic",
